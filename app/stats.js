          ...
          <div className="mx-auto w-full ">
            <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3">
                ...
                <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                  <dt className="text-base leading-7 text-white">Publications scientifiques internationales</dt>
                ...
                <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                    <dt className="text-base leading-7 text-white">Ans d&apos;expérience</dt>
                  <dd className="order-first text-3xl font-semibold tracking-tight text-white sm:text-5xl mx-auto">
                ...
                <div className="mx-auto flex max-w-xs flex-col gap-y-4">
                  <dt className="text-base leading-7 text-white">Evaluations (Athletes, chefs d&apos;entreprise, chirurgiens)</dt>
                  <dd className="order-first text-3xl font-semibold tracking-tight text-white sm:text-5xl mx-auto">
