          ...
          {/* <Swiper
              ...
              >
                ...
                { posts.map( (post, key) => 
                  ...
                  <Popover placement="bottom" showArrow={true}   classNames={{base: "py-3 px-4 bg-white rounded-xl text-sm text-center mt-4",arrow: "bg-default-200",
                  }}>
                      <PopoverTrigger className='cursor-pointer hover:text-white'>
                        ...
                        <PopoverContent>
                            <div className="px-1 py-2 w-96">
                              <div className="text-xs w-[96] text-justify">{post.description}</div>
                            </div>
                        </PopoverContent>
