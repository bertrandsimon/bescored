...
export default function Footer() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_uvsxn6b', 'template_4d95a3p', form.current, 'NgT7PTAfnfr_bHXV2')
      .then((result) => {
      ...
      <div className="mx-auto max-w-7xl px-6 pb-6 pt-2 sm:pt-24 lg:px-8 lg:pt-16">
        ...
        <div className='hidden lg:flex h-full w-full items-center justify-center sm:justify-between'>
          ...
          <div className="mt-10 xl:mt-0">
            ...
            { !success ? 
            <form ref={form} action="#" onSubmit={sendEmail} className="mt-6 sm:flex sm:max-w-md">
          ...
          // success msg
            : <div className="mt-6 flex justify-left items-center mx-auto text-white">Merci, nous vous recontactons rapidement.</div>}
